    ...
    <header>
        <nav class="navbar justify-content-center navbar-expand-lg navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <a class="navbar-brand justify-content-start" href="index.html"><img src="<?php echo base_url('images/') ?>logo/logo.png" alt=""></a>
    ...
    <div id="advertisement" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" style="background-color: black">
            <div class="carousel-item active">
                <img src="<?php echo base_url('images/') ?>banner/1.png" class="d-block mx-auto" alt="São legais mesmo">
            </div>
            <div class="carousel-item">
                <img src="<?php echo base_url('images/') ?>banner/2.png" class="d-block mx-auto" alt="Vai por mim">
            </div>
            <div class="carousel-item">
                <img src="<?php echo base_url('images/') ?>banner/3.png" class="d-block mx-auto" alt="Pode confiar">
            </div>
        </div>
